...
db_root=/net/shared/wietse/data/gro-tts/GroningsSpraak-1.0/wavs # directory including wavfiles
...
num_eval=  # the number of evaluation data
...
pretrain="downloads/ljspeech_parallel_wavegan.v3/checkpoint-3000000steps.pkl" # checkpoint path to load pretrained parameters
